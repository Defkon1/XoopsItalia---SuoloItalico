...
// -------------------------------------------------------------------------------- //
// $Id: modulesadmin.php,v 1.6 2003/03/26 03:33:17 w4z004 Exp $
//%%%%%%	File Name  modulesadmin.php 	%%%%%
define("_MD_AM_MODADMIN","Amministra Moduli");
...
define("_MD_AM_STRTNO","Questo modulo è impostato come modulo di default nella pagina iniziale. Prego modifica il modulo iniziale secondo le tue esigenze.");

// added in RC2
define("_MD_AM_PCMFM","Prego conferma:");
...
define("_MD_AM_BTOMADMIN","Torna alla pagina ' Amministra Moduli'");
