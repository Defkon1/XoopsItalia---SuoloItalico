...
define("_US_REMOVEINFO","Tutte i tuoi dati verrano eliminati.");
...
define('_US_UNEEDAGREE', 'Spiacenti, è necessario accettare le condizioni di utilizzo del servizio, per completare la registrazione.');
define('_US_NOREGISTER','Spiacenti, al moment non è possibile accettare ulteriori registrazioni.');
...
define("_US_YOURREGMAILNG","Adesso sei un utente registrato. Ciò nonostante, non è stato possibile inviarti l'email di attivazione per il tuo account, a causa di un errore verificatosi sul nostro server.<br /> Siamo spiacenti, ti preghiamo di contattare il webmaster via email e segnalare il problema.");
define('_US_YOURREGISTERED2','Adesso sei un utente registrato. Ti preghiamo di attendere l\'attivazione dell\'account da parte di un amministratore. Riceverai un email di notifica una volta che il tuo account sarà stato attivato. Questa operazione potrebbe richiedere del tempo, cerca di essere paziente.');
...
define('_US_SORRYNOTFOUND','Spiacenti, ma non è stata trovata alcuna informazione sull\'utente.');
...
// %s is a username
define("_US_PWDMAILED","La password per l'utente %s è stata inviata.");
define("_US_CONFMAIL","L'email di conferma per l'utente %s è stata inviata.");
define('_US_ACTVMAILNG', 'L\'invio dell\'email di notifica all\'utente %s è fallito!');
...
define('_US_CHOOSEAVT', 'Scegli lista uno degli avatar disponibili.');
