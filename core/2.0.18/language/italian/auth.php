...
define('_AUTH_LDAP_SERVER_NOT_FOUND',"Non è possibile connettersi al server");
define('_AUTH_LDAP_USER_NOT_FOUND',"Utente %s non trovato nella directory del server (%s) in %s");
define('_AUTH_LDAP_CANT_READ_ENTRY',"Non è possibile leggere il valore %s");
define('_AUTH_LDAP_XOOPS_USER_NOTFOUND',"Spiacente, per la connessione: %s <br /> non è stata trovata alcuna informazione per l'utente nel database Xoops" .
