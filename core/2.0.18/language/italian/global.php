...
define("_TAKINGBACK","Stai venendo riportando nel punto in cui eri...");
define("_LOGOUT","Esci");
...
define("_MORE","altro...");
define("_MULTIPAGE","Per visualizzare l'articolo su più pagine, inserire il codicw <font color=red>[pagebreak]</font> (con le quadre), all'interno della news.");
define("_IFNOTRELOAD","Se la pagina non dovesse caricarsi in automatico, clicca <a href=%s>qui</a>");
define("_WARNINSTALL2","ATTENZIONE: La cartella %s è ancora sul server. <br />Si prega di rimuoverla per motivi di sicurezza.");
define("_WARNINWRITEABLE","ATTENZIONE: Il file %s non è protetto in scrittura sul server. <br />Si prega di modificare i permessi di questo file, per motivi di sicurezza:<br /> su server Linux/Unix (CHMOD 444), su Windows (sola lettura)");

// Error messages issued by XoopsObject::cleanVars()
define( "_XOBJ_ERR_REQUIRED", "%s è richiesta/o" );
...
//%%%%%%	File Name admin.php 	%%%%%
define("_NOPERM","Non puoi accedere a questa sezione!");
...
define('_IMGMAXSIZE','Dimensione massima (kbyte):');
...
define("_MESSAGETOOLONG","Il messaggio è troppo lungo.");
