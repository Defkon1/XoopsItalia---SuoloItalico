...
define ('_NOT_CONFIG_ENABLEDDSC', 'Questo sistema consente a un utente di ricevere un avviso al verificarsi di alcuni eventi. Scegliendo "Sì", si attiva quest\'opzione.');
...
define ('_NOT_COMMENTSUBMIT_NOTIFYDSC', 'Inviare un messaggio di notifica ogni volta che un nuovo commento viene inviato (ed è attesa di approvazione) per questo elemento.');
...
define ('_NOT_NOTIFYMETHOD', 'Modalità di notifica: se, per esempio, si vuole tenere d\'occhio un forum, in che modo si desidera ricevere gli avvisi di eventuali aggiornamenti?');
