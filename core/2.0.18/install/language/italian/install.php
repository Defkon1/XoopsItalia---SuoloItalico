...
define("_INSTALL_L0","<h3>Installazione di XOOPS 2.0.X</h3>");
...
define("_INSTALL_L67","E' il nome del server di database. Se non ne sei sicuro, 'localhost' funziona nella maggior parte dei casi.");
...
define("_INSTALL_L64","E' il nome del database sul server. La procedura di installazione tenterà di crearne uno se questo non esiste già.");
...
define("_INSTALL_L63","Questo prefisso verrà aggiunto a tutte le nuove tabelle create per evitare conflitti di nome nel database. Se non hai esigenze particolari, utilizza 'xoops'.");
define("_INSTALL_L54","<b>Utilzzare connessioni persistenti?</b>");
...
define("_INSTALL_L59","E' il percorso fisico sul server della cartella principale di XOOPS.");
...
define("_INSTALL_L31","Impossibile creare il database. Contatta l'amministratore del server per ulteriori dettagli.");
...
define("_INSTALL_L74","Conferma della password");
...
define("_INSTALL_L60","Impossibile aprire il file mainfile.php. Controlla i permessi e prova ancora.");
define("_INSTALL_L61","Impossibile scrivere il file mainfile.php. Contatta l'amministratore del server per ulteriori dettagli.");
...
define("_INSTALL_L90","Configurazione generale");
...
define("_INSTALL_L94","Controllo del percorso e dell'URL");
//define("_INSTALL_L94a","<br>");
define("_INSTALL_L127","Controllo delle impostazioni del percorso e dell'URL in corso..");
define("_INSTALL_L95","Non è stato possibile rilevare il percorso fisico alla tua directory di XOOPS");
...
define("_INSTALL_L102","Conferma impostazioni del database");
define("_INSTALL_L103","Torna all'inizio");
define("_INSTALL_L104","Controllo del database");
...
define("_INSTALL_L105","Tentativo di creazione del database");
define("_INSTALL_L106","Non è stato possibile connettersi al server del database.");
define("_INSTALL_L107","Si prega di verificare la configurazione del server del database.");
define("_INSTALL_L108","Connessione al server del database VALIDA.");
define("_INSTALL_L109","Il database <b>%s</b> non esiste.");
define("_INSTALL_L110","Il database <b>%s</b> esiste e ci si può connettere.");
...
define("_INSTALL_L141","La procedura d'installazione aggiornerà ora ogni modulo per lavorare con XOOPS 2.<br />Assicurati di aver caricato tutti i file del pacchetto di XOOPS 2 sul tuo server.<br />L'operazione richiederà qualche secondo.");
define("_INSTALL_L142","Aggiornamento moduli in corso..");
define("_INSTALL_L143","La procedura d'installazione aggiornerà ora i dati delle impostazioni di XOOPS 1.3.x per essere utilizzati con XOOPS 2.");
...
define("_INSTALL_L149","La procedura d'installazione aggiornerà ora i commenti in XOOPS 1.3.x per essere utilizzati con XOOPS 2.<br />L'operazione richiederà qualche istante.");
define("_INSTALL_L150","La procedura d'installazione aggiornerà ora le faccine e i livelli degli utenti per essere utilizzati con XOOPS 2.<br />L'operazione richiederà qualche secondo.");
...
define("_INSTALL_L157","Scegli il gruppo utenti di default per ogni tipo di gruppo.");
...
define('_INSTALL_L128', 'Seleziona la lingua che vuoi utilizzare durante il processo di installazione.');
