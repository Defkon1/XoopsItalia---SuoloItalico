...
define('_MD_AM_SELFDELETE','Consenti agli utenti di eliminare il loro account?');
...
define('_MD_AM_USEMYSESSDSC','Seleziona \'Sì\' per personalizzare i valori della sessione.');
define('_MD_AM_SESSNAME','Nome sessione');
define('_MD_AM_SESSNAMEDSC','Il nome personalizzato della sessione. <br />(Valido solo se \'Utilizza sessioni personalizzate\' è attivo)');
define('_MD_AM_SESSEXPIRE','Durata della sessione');
define('_MD_AM_SESSEXPIREDSC','Durata massima della sessione in minuti.<br />(Valido solo se \'Utilizza sessioni personalizzate\' è attivo). Funziona solo se si utilizza PHP4.2.0 o successive.)');
...
define('_MD_AM_COMMODE','Modalità di visualizzazione dei commenti');
...
define('_MD_AM_DEBUGMODEDSC','Vi sono varie possibilità di visualizzare il debug, ma un sito online non dovrebbe avere nessuna di queste opzioni abilitate.');
...
define('_MD_AM_ACTVTYPE','Seleziona la modalità di attivazione per i nuovi utenti registrati');
...
define('_MD_AM_DOBADIPS', 'Abilita il blocco (ban) di indirizzi IP?');
...
define('_MD_AM_METAKEYDSC', 'Le parole chiave sono una serie di termini che sintetizzano il contenuto offerto dal tuo sito. Inserisci ogni parola separandola con una virgola o uno spazio. (Es. XOOPS, PHP, mySQL, portale italiano).');
...
define('_MD_AM_METAAUTHORDSC', 'Il metatag \'author\' definisce l\'autore del documento che si sta leggendo. Il valore può essere: il nome, l\'indirizzo email del webmaster, il nome dell\'azienda o l\'URL.');
define('_MD_AM_METACOPYR', 'Meta Copyright');
define('_MD_AM_METACOPYRDSC', 'Il metatag \'copyright\' definisce qualsiasi dichiarazione si voglia divulgare circa i diritti di proprietà del materiale pubblicato nel sito.');
define('_MD_AM_METADESC', 'Meta Description');
define('_MD_AM_METADESCDSC', 'Il metatag \'description\' è una descrizione generale del contenuto e degli argomenti del sito');
define('_MD_AM_METAFOOTER', 'Metatag e Piè di pagina');
define('_MD_AM_FOOTER', 'Piè di pagina');
define('_MD_AM_FOOTERDSC', 'Assicurati di inserire il link completo iniziando da http://, altrimenti il link non funzionerà correttamente nella pagine dei moduli.');
define('_MD_AM_CENSOR', 'Impostazioni di Censura delle parole');
define('_MD_AM_DOCENSOR', 'Abilita la censura di parole indesiderate?');
define('_MD_AM_DOCENSORDSC', 'Se questa opzione è abilitata i termini impostati di seguito saranno censurati. Questa opzione può essere disabilitata per aumentare la velocità del sito.');
define('_MD_AM_CENSORWRD', 'Parole da censurare');
define('_MD_AM_CENSORWRDDSC', 'Inserisci le parole che dovrebbero essere censurate nei messaggi degli utenti.<br />Separa ogni termine con <strong>|</strong>, case insensitive.');
...
define('_MD_AM_DSPDSCLMRDSC', 'Seleziona \'Sì\' per mostrare le condizioni d\'uso nella pagina di registrazione degli utenti');
...
define('_MD_AM_ALLOWREGDSC', 'Seleziona \'Sì\' per consentire la registrazione di nuovi utenti');
define('_MD_AM_THEMEFILE', 'Permettere le modifiche a templates/tema?');
define('_MD_AM_THEMEFILEDSC', 'Se questa opzione è abilitata il tema e/o i templates modificati saranno ricompilati in automatico ad ogni reload della pagina visualizzando eventuali modifiche.<br />Sconsigliato su siti in produzione.');
define('_MD_AM_CLOSESITE', 'Chiudere il sito?');
define('_MD_AM_CLOSESITEDSC', 'Seleziona \'Sì\' per chiudere il sito e far in modo che solo gli utenti nei gruppi selezionati abbiano accesso al sito');
...
define('_MD_AM_CLOSESITETXTDSC', 'Il testo da visualizzare quando il sito è chiuso. <br />E\' possibile utilizzare codice html.');
