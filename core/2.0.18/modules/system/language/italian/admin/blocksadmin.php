...
define("_AM_MODULECANT","Questo blocco non può essere eliminato direttamente! Se vuoi disabilitare questo blocco, disattiva il relativo modulo.");
...
define("_AM_BLOCKTAG1","%s visualizzerà %s");
...
define('_AM_NOTSELNG', "'%s' non è selezionato!"); // messaggio di errore
