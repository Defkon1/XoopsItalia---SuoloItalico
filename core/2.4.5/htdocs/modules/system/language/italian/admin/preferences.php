...
define('_MD_AM_SITEPREF','Preferenze del sistema');
...
define("_MD_AM_CPANELDSC", "Layout alternativi per il lato admin.<br />Installabili nella cartella /modules/system/class/gui.");
